...
namespace SAPProjectDesserts {
    ...
    public partial class DatabaseDataSet4 : global::System.Data.DataSet {
        ...
        public partial class OrderDataTable : global::System.Data.TypedTableBase<OrderRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public OrderRow AddOrderRow(int Desserts, int Quantity, int Total) {
            ...
            private void InitClass() {
                this.columnID_Customer = new global::System.Data.DataColumn("ID_Customer", typeof(int), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnID_Customer);
                this.columnDesserts = new global::System.Data.DataColumn("Desserts", typeof(int), null, global::System.Data.MappingType.Element);
        ...
        public partial class OrderRow : global::System.Data.DataRow {
            ...
            public int Desserts {
                get {
                    return ((int)(this[this.tableOrder.DessertsColumn]));
                }
                set {
...
namespace SAPProjectDesserts.DatabaseDataSet4TableAdapters {
...
SELECT ID_Customer, Company, Name, Mobile FROM Customer WHERE (ID_Customer = @ID_Customer)";
        ...
        public virtual int Fill(DatabaseDataSet4.CustomerDataTable dataTable) {
        ...
        public virtual DatabaseDataSet4.CustomerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet4.CustomerDataTable dataTable = new DatabaseDataSet4.CustomerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet4.CustomerDataTable dataTable) {
    ...
    public partial class OrderTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Order] WHERE (([ID_Customer] = @Original_ID_Customer) AND ([Desserts] = @Original_Desserts) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ((@IsNull_Total = 1 AND [Total] IS NULL) OR ([Total] = @Original_Total)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ID_Customer", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ID_Customer", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Desserts", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Desserts", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Order] ([Desserts], [Quantity], [Total]) VALUES (@Desserts, @Q" +
                "uantity, @Total);\r\nSELECT ID_Customer, Desserts, Quantity, Total FROM [Order] WH" +
                "ERE (ID_Customer = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Desserts", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Desserts", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Order] SET [Desserts] = @Desserts, [Quantity] = @Quantity, [Total] = @Total WHERE (([ID_Customer] = @Original_ID_Customer) AND ([Desserts] = @Original_Desserts) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ((@IsNull_Total = 1 AND [Total] IS NULL) OR ([Total] = @Original_Total)));
SELECT ID_Customer, Desserts, Quantity, Total FROM [Order] WHERE (ID_Customer = @ID_Customer)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Desserts", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Desserts", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ID_Customer", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ID_Customer", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Desserts", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Desserts", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT ID_Customer, Desserts, Quantity, Total FROM dbo.[Order]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DatabaseDataSet4.OrderDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DatabaseDataSet4.OrderDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet4.OrderDataTable dataTable = new DatabaseDataSet4.OrderDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet4.OrderDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_ID_Customer, int Original_Desserts, global::System.Nullable<int> Original_Quantity, global::System.Nullable<int> Original_Total) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_ID_Customer));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_Desserts));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int Desserts, global::System.Nullable<int> Quantity, global::System.Nullable<int> Total) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(Desserts));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Desserts, global::System.Nullable<int> Quantity, global::System.Nullable<int> Total, int Original_ID_Customer, int Original_Desserts, global::System.Nullable<int> Original_Quantity, global::System.Nullable<int> Original_Total, int ID_Customer) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(Desserts));
            if ((Quantity.HasValue == true)) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_ID_Customer));
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_Desserts));
            if ((Original_Quantity.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((object)(0));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Desserts, global::System.Nullable<int> Quantity, global::System.Nullable<int> Total, int Original_ID_Customer, int Original_Desserts, global::System.Nullable<int> Original_Quantity, global::System.Nullable<int> Original_Total) {
            return this.Update(Desserts, Quantity, Total, Original_ID_Customer, Original_Desserts, Original_Quantity, Original_Total, Original_ID_Customer);
        }
    }
...
SELECT ID_Customer, Company, Name, Mobile FROM [Table] WHERE (ID_Customer = @ID_Customer)";
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet4.TableDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
...
SELECT ID_User, Username, Password, Name, Contact, Address FROM [User] WHERE (ID_User = @ID_User)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DatabaseDataSet4.UserDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DatabaseDataSet4.UserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet4.UserDataTable dataTable = new DatabaseDataSet4.UserDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet4.UserDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
